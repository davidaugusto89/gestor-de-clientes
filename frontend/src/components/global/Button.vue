<template>
  <button :class="[
    'btn w-full items-center justify-center py-2 px-4 rounded-lg font-medium transition-all duration-300 focus:outline-none',
    isLoading ? 'opacity-50 cursor-not-allowed' : '',
    typeClass,
  ]" :disabled="isLoading">
    <svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101"
      fill="none" xmlns="http://www.w3.org/2000/svg" v-if="isLoading">
      <path
